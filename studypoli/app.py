...
with st.sidebar:
    ...
    <div style="background: rgba(27,42,74,0.05); border: 1px solid rgba(27,42,74,0.12); border-radius: 10px; padding: 10px 14px; margin: 10px 0;">
        <div style="font-size: 0.75rem; text-transform: uppercase; color: #4B5A78; font-weight: 700;">Estudante</div>
        <div style="font-size: 1.05rem; font-weight: 800; color: #1B2A4A;">{settings.get('student_name', 'Meu Nome')}</div>
        <div style="font-size: 0.8rem; color: #2563EB;">🏛️ {settings.get('institution_name', 'Minha Instituição')}</div>
    </div>
