...
def render_attendance_view(dm):
    ...
    if not subjects:
        ...
        <div style="background: rgba(59, 130, 246, 0.1); border: 2px dashed rgba(96, 165, 250, 0.4); border-radius: 14px; padding: 30px; text-align: center; margin: 20px 0;">
            ...
            <div style="font-size: 1.25rem; font-weight: 700; color: #1B2A4A;">Nenhuma matéria cadastrada ainda!</div>
            <div style="color: #4B5A78; font-size: 0.9rem; margin-top: 6px;">
            ...
            with col_info:
                ...
                <div style="background: rgba(27,42,74,0.05); border-left: 5px solid {subj.get('color', '#3B82F6')}; 
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-weight: 700; font-size: 1.15rem; color: #1B2A4A;">
                            {subj['name']} <span style="font-size: 0.8rem; color: #4B5A78; font-weight: normal;">({subj.get('code', '---')})</span>
                        </span>
                    ...
                    <div style="font-size: 0.85rem; color: #4B5A78; margin: 4px 0 10px 0;">
                        Docente: {subj.get('professor', 'Não informado')} · Total de Aulas: {stats['total_classes']} · Média Mínima: {subj.get('passing_grade', 6.0)}
                    </div>
                    <div style="display: flex; justify-content: space-between; font-size: 0.85rem; color: #33456B; font-weight: 600;">
