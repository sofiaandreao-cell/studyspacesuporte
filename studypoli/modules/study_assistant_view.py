        ...
        if not tasks:
                ...
                for t in pending_tasks:
                    ...
                    with col_txt:
                        ...
                        <div style="background: rgba(27,42,74,0.045); padding: 8px 12px; border-radius: 8px; border-left: 4px solid {s.get('color', '#3B82F6')}; margin-bottom: 6px;">
                            <span style="font-weight: 600; color: #1B2A4A;">{t['text']}</span>
                            <div style="font-size: 0.75rem; color: #4B5A78; margin-top: 2px;">
            ...
            with col_done:
                ...
                for t in done_tasks:
                    ...
                    with col_txt:
                        st.markdown(f"""
                        <div style="background: rgba(27,42,74,0.04); padding: 8px 12px; border-radius: 8px; margin-bottom: 6px; text-decoration: line-through; color: #5B6B8C;">
    ...
    with tab_pomodoro:
        ...
        with cp2:
            ...
            <div style="background: rgba(27,42,74,0.07); border: 2px solid #2563EB; border-radius: 20px; padding: 30px; text-align: center; box-shadow: 0 0 25px rgba(96, 165, 250, 0.2);">
                <div style="font-size: 0.9rem; text-transform: uppercase; letter-spacing: 0.1em; color: #4B5A78;">Ciclo Atual</div>
                <div style="font-size: 3.5rem; font-weight: 800; font-family: 'JetBrains Mono', monospace; color: #1B2A4A; margin: 10px 0;">
            ...
            if st.button("▶️ Iniciar Timer", use_container_width=True):
                ...
                for remaining in range(target_secs, -1, -1):
                    ...
                    <div style="text-align: center; font-size: 3rem; font-weight: 800; font-family: 'JetBrains Mono', monospace; color: #1B2A4A;">
                        {mins:02d}:{secs:02d}
                    </div>
                    """, unsafe_allow_html=True)
